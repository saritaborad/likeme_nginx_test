...
ssh -i $ssh_key_path root@$deploy_host "cd $deploy_path/backend && npm install --legacy-peer-deps && /usr/local/bin/pm2 restart likeme_test && /usr/local/bin/pm2 logs likeme_test"
